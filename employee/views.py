...
def edit_empeducation(request,pid):
    if not request.user.is_authenticated:
        return redirect('admin_login')
    error = ""
    user = User.objects.get(id=pid)
    ...
    if request.method == "POST":
        ...
        try:
            ...
            error = "yes"
    return render(request,'edit_empeducation.html',locals())



def edit_empexperience(request,pid):
    if not request.user.is_authenticated:
        return redirect('admin_login')
    error = ""
    user = User.objects.get(id=pid)
    ...
    if request.method == "POST":
        ...
        try:
            ...
            error = "yes"
    return render(request,'edit_empexperience.html',locals())
